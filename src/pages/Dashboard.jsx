...
import "../assets/css/bankingApp.css";
...
function Dashboard() {
  ...
  return (
    <div className="app">
      ...
      {activeTakeLoanModal && (
        <TakeLoanModal 
          closeModal={() => closeModal('takeLoan')} 
        />
      )}

      {activePayLoanModal && (
        <PayLoanModal 
          closeModal={() => closeModal('payLoan')} 
        />
      )}

      {activeBuyAirtimeModal && (
        <BuyAirtimeModal 
          closeModal={() => closeModal('buyAirtime')} 
        />
      )}

      {activeCheckStatusModal && (
        <CheckStatusModal 
          closeModal={() => closeModal('checkStatus')} 
        />
      )}
    </div>
  );
